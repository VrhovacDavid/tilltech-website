<template>
    ...
    <main class="relative isolate min-h-full">
      ...
      <div class="mx-auto max-w-7xl px-6 py-32 text-center sm:py-40 lg:px-8">
        ...
        <h1 class="mt-4 text-3xl font-bold tracking-tight text-white sm:text-5xl">Seite nich gefunden</h1>
        <p class="mt-4 text-base text-white/70 sm:mt-6">Sorry, wir konnten die Seite die du gesucht hast nicht finden.</p>
        <div class="mt-10 flex justify-center">
          <a href="/" class="text-sm font-semibold leading-7 text-white"><span aria-hidden="true">&larr;</span>Zurück zur Homepage</a>
        </div>
      </div>
    </main>
  </template>
