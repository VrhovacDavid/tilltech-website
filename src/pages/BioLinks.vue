<template>
    <div
        ...
        <div
            class="shadow-2xl shadow-black/60 z-10 h-[50vh] lg:h-[80vh] xl:h-[80vh] rounded-br-3xl background-gradient w-10/12 md:w-11/12  lg:w-1/2 xl:w-1/2  flex flex-col justify-center items-start ">
            <div class="text-left z-10  px-4 max-w-4xl  flex-grow flex-col flex items-center justify-center">





                <img class="h-32 w-32 ring-2 ring-white rounded-full my-2 " src="/Branding/David.webp" alt="">
                ...
                <div class=" pt-4 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
        ...
        <div class="w-full mx-auto px-4 pt-12">
