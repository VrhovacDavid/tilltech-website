<template>
  <div class="bg-primary">
    <div class="h-96 background-gradient flex flex-col justify-center items-start px-4">
      <h1 class="p-1.5 text-mobile-bodySM bg-neutral-50/20 rounded-lg border-2 my-2 border-white text-white">Design
        Portfolio</h1>
      <h2 class="text-mobile-h1 leading-mobile-h1 my-2 font-black text-white">Unsere Arbeiten</h2>
      <p class="text-white text-mobile-body leading-mobile-body ">Hier findest du ein Teil unserer Arbeiten die wir bei
        der TillTech gemacht haben!
      </p>

      <a href="/#pricing"
        class="text-mobile-body sm:text-base my-2 px-4 font-bold bg-btn-black shadow-lg shadow-white/20 rounded-full py-2 text-white">
        Projekt Starten
      </a>
    </div>
