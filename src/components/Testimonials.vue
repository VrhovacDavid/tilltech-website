            ...
            <div class="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8">
                <blockquote class="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                    <div class="flex items-center gap-4">
                        <img alt="Maximilian Murtinger"
                            src="/Testimonials/MaximilianMurtinger.webp"
                            class="size-14 rounded-full object-cover" />

                        <div>
                            <div class="flex justify-start gap-0.5 text-p-gradient1">
                            ...
                            <p class="mt-0.5 text-mobile-bodyLG font-medium text-headings">Maximilian Murtinger</p>
                            <p class="mt-0.5 text-mobile-bodySM  text-highlights">NextFertility St. Gallen AG</p>
                        </div>
                    </div>

                    <p class="mt-4 text-mobile-body  text-paragraphs">
                ...
                <blockquote class="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                    <div class="flex items-center gap-4">
                        <img alt=""
                            src="/Testimonials/JessicaZeder.webp"
                            class="size-14 rounded-full object-cover" />
                        ...
                        <div>
                            ...
                            <p class="mt-0.5  text-mobile-bodyLG font-medium text-headings">Jessica Zeder</p>
                            <p class="mt-0.5  text-mobile-bodySM  text-highlights">Dipon Schweiz GmbH</p>
                        </div>
                    </div>
                    ...
                    <p class="mt-4  text-mobile-body text-paragraphs">
                        ...
                        Zusammenarbeit. Danke dir David 😉
                    </p>
                </blockquote>
                ...
                <blockquote class="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                    <div class="flex items-center gap-4">
                        <img alt=""
                            src="/Testimonials/MarkusKathriner.webp"
                            class="size-14 rounded-full object-cover" />
                        ...
                        <div>
                            ...
                            <p class="mt-0.5  text-mobile-bodyLG font-medium text-headings">Markus Kathriner</p>
                            <p class="mt-0.5  text-mobile-bodySM  text-highlights">Der Schrankspezialist GmbH</p>
