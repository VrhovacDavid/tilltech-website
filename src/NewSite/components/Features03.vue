        ...
        <div class="lg:flex space-y-12 lg:space-y-0 lg:space-x-12 xl:space-x-24">
          ...
          <div class="lg:max-w-none lg:min-w-[524px]">
            <div class="mb-8">
              ...
              <h3 class="font-inter-tight text-3xl font-bold text-zinc-200 mb-4">So funktioniert TillTech</h3>
            ...
            <div class="mb-8 md:mb-0 space-y-2">
              ...
              >
                ...
                <div>
                  <div class="font-inter-tight text-lg font-semibold text-zinc-200 mb-1">Einfacher Start</div>
                  <div class="text-zinc-500">Hole den passenden Plan und erhalte eine Bestätigungs-E-Mail. Melde dich bei Trello an, um loszulegen.</div>
                </div>
              </button>
              <button
              ...
              >
                ...
                <div>
                  <div class="font-inter-tight text-lg font-semibold text-zinc-200 mb-1">Anfragen stellen</div>
                  <div class="text-zinc-500">Stelle deine IT-Anfragen direkt über Trello. Unser Team bearbeitet sie sofort.</div>
                </div>
              </button>
              <button
              ...
              >
                ...
                <div>
                  <div class="font-inter-tight text-lg font-semibold text-zinc-200 mb-1">Schnelle Lieferung</div>
                  <div class="text-zinc-500">Innerhalb von 1-2 Tagen erhältst du deine fertigen Ergebnisse. Einfach, schnell und effizient.</div>
                </div>
              </button>
            </div>
          </div>
            ...
            <div class="relative flex flex-col">
              ...
              >              
                <div class="w-full" v-show="tab === '1'">
                  <div>
                    <img class="lg:max-w-none mx-auto rounded-lg shadow-2xl" src="/carousel-illustration-01.jpg" width="800" height="620" alt="Carousel 01" />
                  </div>
                </div>
              </transition>
              <!-- Item 2 -->
              ...
              >              
                <div class="w-full" v-show="tab === '2'">
                  <div>
                    <img class="lg:max-w-none mx-auto rounded-lg shadow-2xl" src="/carousel-illustration-01.jpg" width="800" height="620" alt="Carousel 02" />
                  </div>
                </div>
              </transition>
              <!-- Item 3 -->
              ...
              >              
                <div class="w-full" v-show="tab === '3'">
                  <div>
                    <img class="lg:max-w-none mx-auto rounded-lg shadow-2xl" src="/carousel-illustration-01.jpg" width="800" height="620" alt="Carousel 03" />
                  </div>
                </div>
              </transition>
            </div>
            <!-- Gear illustration -->
            <img class="absolute left-0 bottom-0 -translate-x-1/2 translate-y-1/3 mix-blend-exclusion max-lg:w-32" src="/features-illustration.png" alt="Features 02 illustration" width="173" height="167" aria-hidden="true">
          </div>
