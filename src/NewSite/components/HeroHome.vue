  ...
  <section
    ...
    <div class="pt-32 pb-12 md:pt-40 md:pb-20">
        ...
        <div class="max-w-3xl mx-auto">
          <div class="text-center pb-12 md:pb-16">
            ...
            <p class="text-lg text-zinc-500 mb-8">
              Ihre Schweizer SEO Agentur spezialisiert auf Suchmaschinenoptimierung. Wir helfen Ihnen online dauerhaft
              sichtbar und erfolgreich zu werden. Entdecken Sie Ihr SEO-Potenzial in einem kostenlosen Erstgespräch!
            </p>
            <div
              class="max-w-xs mx-auto sm:max-w-none sm:inline-flex sm:justify-center space-y-4 sm:space-y-0 sm:space-x-4">
              <div>
                <router-link class="btn text-zinc-100 bg-zinc-900 hover:bg-zinc-800 w-full shadow"
                  to="/request-demo">Kostenloses Erstgespräch </router-link>
              </div>
              <div>
                <a class="btn text-zinc-600 bg-white hover:text-zinc-900 w-full shadow" href="#0">Starten</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div
        ...
        <img class="rounded-lg shadow-2xl" src="/hero-image.png" width="1104" height="620" alt="Hero">
      </div>
