    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div
          ...
          <ul class="text-sm flex grow justify-center flex-wrap items-center gap-4 lg:gap-8">
            <li class="px-3 py-1">
              <router-link class="text-gray-700 hover:text-gray-900 flex items-center transition"
                to="/pricing">Preise</router-link>
            </li>
            <li class="px-3 py-1">
              <router-link class="text-gray-700 hover:text-gray-900 flex items-center transition"
                to="/customers">Portfolio</router-link>
            </li>
            <li class="px-3 py-1">
              <router-link class="text-gray-700 hover:text-gray-900 flex items-center transition"
        ...
        <ul class="flex-1 flex justify-end items-center gap-3">
          <li>
            <router-link class="btn-sm text-gray-800 bg-white hover:bg-gray-50 shadow" to="/signin">Starten</router-link>
          </li>
          <li>
            <router-link class="btn-sm text-gray-200 bg-gray-800 hover:bg-gray-900 shadow" to="/signup">Termin Buchen</router-link>
          </li>
        </ul>
